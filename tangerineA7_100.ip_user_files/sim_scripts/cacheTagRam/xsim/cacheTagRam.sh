...
#
# Script generated by Vivado on Tue Feb 25 09:16:31 +0100 2025
...
simulate()
{
  xsim cacheTagRam -key {Behavioral:sim_1:Functional:cacheTagRam} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
