...
#
# Script generated by Vivado on Sun Feb 16 11:39:09 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : cacheTagRam.sh
...
#
# Usage        : cacheTagRam.sh
#                cacheTagRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cacheTagRam.sh [-reset_run]
#                cacheTagRam.sh [-reset_log]
#                cacheTagRam.sh [-help]
#
...
# script info
echo -e "cacheTagRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cacheTagRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cacheTagRam xil_defaultlib.cacheTagRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cacheTagRam -key {Behavioral:sim_1:Functional:cacheTagRam} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cacheTagRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cacheTagRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cacheTagRam.sh [-help]\n\
Usage: cacheTagRam.sh [-step]\n\
Usage: cacheTagRam.sh [-lib_map_path]\n\
Usage: cacheTagRam.sh [-reset_run]\n\
Usage: cacheTagRam.sh [-reset_log]\n\
Usage: cacheTagRam.sh [-keep_index]\n\
Usage: cacheTagRam.sh [-noclean_files]\n\n\
