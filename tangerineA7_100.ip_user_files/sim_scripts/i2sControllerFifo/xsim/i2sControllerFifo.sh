...
#
# Script generated by Vivado on Thu Feb 27 20:59:32 +0100 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot i2sControllerFifo xil_defaultlib.i2sControllerFifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim i2sControllerFifo -key {Behavioral:sim_1:Functional:i2sControllerFifo} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
