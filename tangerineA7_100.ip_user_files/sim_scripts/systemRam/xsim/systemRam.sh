...
#
# Script generated by Vivado on Mon Feb 10 08:52:09 +0100 2025
...
# script info
echo -e "systemRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot systemRam xil_defaultlib.systemRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim systemRam -key {Behavioral:sim_1:Functional:systemRam} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
