...
#
# Script generated by Vivado on Tue Feb 11 13:54:50 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : mig_7series_tangerine.sh
...
#
# Usage        : mig_7series_tangerine.sh
#                mig_7series_tangerine.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mig_7series_tangerine.sh [-reset_run]
#                mig_7series_tangerine.sh [-reset_log]
#                mig_7series_tangerine.sh [-help]
#
...
# script info
echo -e "mig_7series_tangerine.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mig_7series_tangerine.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mig_7series_tangerine xil_defaultlib.mig_7series_tangerine xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mig_7series_tangerine -key {Behavioral:sim_1:Functional:mig_7series_tangerine} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mig_7series_tangerine.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mig_7series_tangerine.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mig_7series_tangerine.sh [-help]\n\
Usage: mig_7series_tangerine.sh [-step]\n\
Usage: mig_7series_tangerine.sh [-lib_map_path]\n\
Usage: mig_7series_tangerine.sh [-reset_run]\n\
Usage: mig_7series_tangerine.sh [-reset_log]\n\
Usage: mig_7series_tangerine.sh [-keep_index]\n\
Usage: mig_7series_tangerine.sh [-noclean_files]\n\n\
