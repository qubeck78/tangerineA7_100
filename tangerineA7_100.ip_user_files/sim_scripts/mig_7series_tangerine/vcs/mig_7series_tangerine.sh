...
#                script (type 'mig_7series_tangerine.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mig_7series_tangerine xil_defaultlib.glbl -o mig_7series_tangerine_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mig_7series_tangerine_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mig_7series_tangerine_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mig_7series_tangerine_simv.daidir vcs_lib c.obj)
