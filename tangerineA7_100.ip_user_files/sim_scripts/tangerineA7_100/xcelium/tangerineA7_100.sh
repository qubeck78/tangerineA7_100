...
#
# Script generated by Vivado on Tue Feb 25 18:11:31 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : tangerineA7_100.sh
...
#
# Usage        : tangerineA7_100.sh
#                tangerineA7_100.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tangerineA7_100.sh [-reset_run]
#                tangerineA7_100.sh [-reset_log]
#                tangerineA7_100.sh [-help]
#
...
#                script (type 'tangerineA7_100.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname xlslice_v1_0_2 -libname xlconstant_v1_1_7 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib xlslice_v1_0_2 xlconstant_v1_1_7)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "tangerineA7_100.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tangerineA7_100.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"$ref_dir/../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" +incdir+"../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"$ref_dir/../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" +incdir+"../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" \
  ...
  xmvlog -work xlslice_v1_0_2 $xmvlog_opts +incdir+"$ref_dir/../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" +incdir+"../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" \
  ...
  xmvlog -work xlconstant_v1_1_7 $xmvlog_opts +incdir+"$ref_dir/../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" +incdir+"../../../../tangerineA7_100.gen/sources_1/bd/tangerineA7_100/ipshared/30ef" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.tangerineA7_100 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.tangerineA7_100 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log tangerineA7_100_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tangerineA7_100.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tangerineA7_100.sh [-help]\n\
Usage: tangerineA7_100.sh [-step]\n\
Usage: tangerineA7_100.sh [-lib_map_path]\n\
Usage: tangerineA7_100.sh [-reset_run]\n\
Usage: tangerineA7_100.sh [-reset_log]\n\
Usage: tangerineA7_100.sh [-keep_index]\n\
Usage: tangerineA7_100.sh [-noclean_files]\n\n\
