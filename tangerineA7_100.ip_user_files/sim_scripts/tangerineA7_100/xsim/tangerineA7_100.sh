...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlslice_v1_0_2 -L xlconstant_v1_1_7 -L axi_infrastructure_v1_1_0 -L fifo_generator_v13_2_8 -L axi_clock_converter_v2_1_27 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tangerineA7_100 xil_defaultlib.tangerineA7_100 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tangerineA7_100 -key {Behavioral:sim_1:Functional:tangerineA7_100} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tangerineA7_100.wdb xsim.dir libdpi.so)
