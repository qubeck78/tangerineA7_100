...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlslice_v1_0_2 -L xlconstant_v1_1_7 -L gigantic_mux -L xlconcat_v2_1_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tangerineA7_100 xil_defaultlib.tangerineA7_100 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tangerineA7_100 -key {Behavioral:sim_1:Functional:tangerineA7_100} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
