...
#
# Script generated by Vivado on Sun Feb 16 11:31:38 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : cacheDataRam.sh
...
#
# Usage        : cacheDataRam.sh
#                cacheDataRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cacheDataRam.sh [-reset_run]
#                cacheDataRam.sh [-reset_log]
#                cacheDataRam.sh [-help]
#
...
# script info
echo -e "cacheDataRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cacheDataRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cacheDataRam xil_defaultlib.cacheDataRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cacheDataRam -key {Behavioral:sim_1:Functional:cacheDataRam} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cacheDataRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cacheDataRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cacheDataRam.sh [-help]\n\
Usage: cacheDataRam.sh [-step]\n\
Usage: cacheDataRam.sh [-lib_map_path]\n\
Usage: cacheDataRam.sh [-reset_run]\n\
Usage: cacheDataRam.sh [-reset_log]\n\
Usage: cacheDataRam.sh [-keep_index]\n\
Usage: cacheDataRam.sh [-noclean_files]\n\n\
