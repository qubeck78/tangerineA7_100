...
#
# Script generated by Vivado on Tue Feb 25 09:11:00 +0100 2025
...
simulate()
{
  xsim cacheDataRam -key {Behavioral:sim_1:Functional:cacheDataRam} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
