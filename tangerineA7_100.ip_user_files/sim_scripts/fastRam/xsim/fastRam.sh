...
#
# Script generated by Vivado on Wed Feb 12 13:27:23 +0100 2025
...
#
# Usage        : fastRam.sh
#                fastRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fastRam.sh [-reset_run]
#                fastRam.sh [-reset_log]
#                fastRam.sh [-help]
#
...
# script info
echo -e "fastRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fastRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fastRam xil_defaultlib.fastRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fastRam -key {Behavioral:sim_1:Functional:fastRam} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fastRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fastRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fastRam.sh [-help]\n\
Usage: fastRam.sh [-step]\n\
Usage: fastRam.sh [-lib_map_path]\n\
Usage: fastRam.sh [-reset_run]\n\
Usage: fastRam.sh [-reset_log]\n\
Usage: fastRam.sh [-keep_index]\n\
Usage: fastRam.sh [-noclean_files]\n\n\
