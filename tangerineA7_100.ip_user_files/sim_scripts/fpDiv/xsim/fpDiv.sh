...
#
# Script generated by Vivado on Mon Feb 17 23:06:19 +0100 2025
...
# script info
echo -e "fpDiv.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
simulate()
{
  xsim fpDiv -key {Behavioral:sim_1:Functional:fpDiv} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
