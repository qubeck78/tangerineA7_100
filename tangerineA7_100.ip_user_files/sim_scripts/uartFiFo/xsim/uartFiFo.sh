...
#
# Script generated by Vivado on Sun Feb 09 15:48:58 +0100 2025
...
# script info
echo -e "uartFiFo.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot uartFiFo xil_defaultlib.uartFiFo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim uartFiFo -key {Behavioral:sim_1:Functional:uartFiFo} -tclbatch cmd.tcl -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
