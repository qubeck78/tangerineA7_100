...
#
# Script generated by Vivado on Sat Feb 15 16:50:11 +0100 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L fifo_generator_v13_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ps2ControllerFifo xil_defaultlib.ps2ControllerFifo xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ps2ControllerFifo -key {Behavioral:sim_1:Functional:ps2ControllerFifo} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
