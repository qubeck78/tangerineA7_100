...
#
# Script generated by Vivado on Wed Feb 19 19:50:27 +0100 2025
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : dmaCh2BufRam.sh
...
#
# Usage        : dmaCh2BufRam.sh
#                dmaCh2BufRam.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dmaCh2BufRam.sh [-reset_run]
#                dmaCh2BufRam.sh [-reset_log]
#                dmaCh2BufRam.sh [-help]
#
...
# script info
echo -e "dmaCh2BufRam.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dmaCh2BufRam.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dmaCh2BufRam xil_defaultlib.dmaCh2BufRam xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dmaCh2BufRam -key {Behavioral:sim_1:Functional:dmaCh2BufRam} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_2af6.protoinst" -protoinst "protoinst_files/tangerineA7_100.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dmaCh2BufRam.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dmaCh2BufRam.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dmaCh2BufRam.sh [-help]\n\
Usage: dmaCh2BufRam.sh [-step]\n\
Usage: dmaCh2BufRam.sh [-lib_map_path]\n\
Usage: dmaCh2BufRam.sh [-reset_run]\n\
Usage: dmaCh2BufRam.sh [-reset_log]\n\
Usage: dmaCh2BufRam.sh [-keep_index]\n\
Usage: dmaCh2BufRam.sh [-noclean_files]\n\n\
