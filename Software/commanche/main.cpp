...
uint32_t commanche( tgfBitmap *screen )
{
   ...
   gfFillRect128( screen, 53, 0, 53 + screenwidth, screenheight, 0 );
...
//          mapoffset = ( ( ((int32_t)ply) & mapwidthperiod ) << mapshift ) + ( ((int32_t)plx) & mapheightperiod );
         ...
         {                
            ...
            gfFillRect( screen, 53 + x, heightonscreen, 53 + x, hiddeny[x], color );
...
int main()
{
   ...
   toPrint( &con, (char*)"tangerine A7_100 Commanche B20250222\n" );
   ...
   gfFillRect128( &screen2, 0, 0, screen1.width - 1, screen1.height - 1 , gfColor( 0, 0, 0 ) ); 
